...
%\title{Calibrating building energy simulation models: Building a foundation for advancing knowledge}

% \title{A review on the basics for advancing knowledge calibrating building energy simulation models}
% \title{A review on the basics in calibrating building energy simulation models}
% \title{A review that builds the foundation for advancing knowledge in the calibration of building energy models}
\title{Calibrating building energy simulation models: A review of the basics to guide future work}

%\title{Calibrating building energy simulation models: A review to facilitate future developments}
...
In Section \ref{sec:method} we describe the methodology of our systematic review. Section \ref{sec:context} contextualizes the review with an overview of the simulation engine used, and the location of case studies. Section \ref{sec:calib_approach} describes the state-of-the-art calibration approaches, including a comparison against the 2014 review by Coakley et al. \cite{coakley2014review}. Section \ref{sec:data_req} analyzes the relationship between the inputs and outputs used for calibration. Section \ref\label{sec:calib_performance} summarizes the metrics commonly used to evaluate calibration performance. Section \ref{sec:discussion} discusses the significant findings and identifies areas for future research. Section \ref{sec:conclusion} concludes the paper.
...
\caption{Classification of model inputs when calibration an energy model.}
...
%Previous studies overcome this limitation by using supercomputers \cite{garrett2015scalable}, pattern-based approaches, or focusing on parts of the schedule (e.g., base loads) \cite{chong2021occupancy}. 
